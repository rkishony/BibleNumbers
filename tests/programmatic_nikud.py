...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [("וּבַשָּׁנָה הָאַחַת עֶשְׂרֵה", Time(11, is_date=True)), ("שֶׁבַע שָׁנִים", Time(7))],
        ),
        ...
        (
            ...
            [("בְּאַחַת וְשֵׁשׁ מֵאוֹת שָׁנָה", Time(601)), ("בְּאֶחָד לַחֹדֶשׁ", Time(days=1, is_date=True))]
        ),
        (
            ...
            [("עֶשְׂרִים", 20), ("עַשְׁתֵּי עֶשְׂרֵה", 11)]
        ),
        (
            "וּבַחֹדֶשׁ הָרִאשׁוֹן בְּאַרְבָּעָה עָשָׂר יוֹם לַחֹדֶשׁ פֶּסַח לַיהוָה",
            [("בְּאַרְבָּעָה עָשָׂר יוֹם לַחֹדֶשׁ", Time(days=14, is_date=True))]
        ),
        (
